- ### 14.7.1 InnoDB锁定
  ...
  除全表请求（例如[`LOCK TABLES ... WRITE`](https://dev.mysql.com/doc/refman/5.7/en/lock-tables.html)）以外，意向锁不会阻止任何内容。意图锁定的主要目的是表明有人正在锁定表中的行，或者打算锁定表中的行。
  ...
  更 多信息，请参见 [第14.6.1.6节“ InnoDB中的AUTO_INCREMENT处理”](https://dev.mysql.com/doc/refman/5.7/en/innodb-auto-increment-handling.html)。
